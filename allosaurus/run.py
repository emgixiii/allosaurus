...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=int,
        default=-1,
        help="specify cuda device id to use, -1 means no cuda and will use cpu for inference",
    )
    parser.add_argument(
        "-m",
        "--model",
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="specify your input wav file/directory",
    )
    parser.add_argument(
        "-o",
        "--output",
    ...
    parser.add_argument(
        ...
        type=int,
        default=1,
        help="output k phone for each emitting frame",
    )
    parser.add_argument(
        "-t",
        "--timestamp",
    ...
    parser.add_argument(
        ...
        required=False,
        default=None,
        help="supply prior to adjust phone predictions",
    )
    parser.add_argument(
        "-e",
        "--emit",
    ...
    if input_path.is_dir():
        ...
        # check file format
        assert args.input.endswith(".wav"), (
